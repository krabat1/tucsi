...
function buildPage(pageName) {
    ...
    const content = fs.readFileSync(path.join(SRC_DIR, `${pageName}.html`), 'utf8');
...
if (process.argv[2] === 'build') {
    ...
    console.log('--- A statikus fájlok átmásolva! ---');
} 
...
// 3. MÓD: SSR (Csak a játék kedvéért, élőben generálja)
    ...
    }).listen(3000, () => console.log('SSR Mód: Figyelek a http://localhost:3000 címen...'));
}